  ...
  const pacotes = [
    {
      ...
      preco: "R$ 130/pessoa",
      duracao: "Entre 5 e 7 horas",
      pessoas: "Até 10 pessoas",
      descricao: "Aventura 4x4 pelo Parque Estadual até a praia mais famosa de Ilhabela.",
      features: ["Trilha 4x4", "Praia Castelhanos", "Guia especializado"],
      rating: 4.9,
      destaque: true,
      comoFunciona: "Inesquec\u00edveis aventuras offroad pelo Parque Estadual de Ilhabela, em meio \u00e0 exuberante Mata Atl\u00e2ntica, com paradas em cachoeiras refrescantes e mirante privilegiado para fotos e contempla\u00e7\u00e3o da natureza. O restante do dia \u00e9 todo seu para se divertir na parad\u00eds\u00edaca Praia dos Castelhanos. Sa\u00edda \u00e0s 10h da marina central. Paradas estrat\u00e9gicas nas cachoeiras e no mirante no caminho at\u00e9 a praia. Tempo livre para banho e explora\u00e7\u00e3o. Retorno entre 15h e 17h pelo mesmo trajeto com paradas diferentes (hor\u00e1rio a combinar)."
    },
    {
      id: 2,
      ...
      pessoas: "Até 10 pessoas",
      descricao: "Passeio emocionante de lancha pela costa até a deslumbrante Praia dos Castelhanos, com paradas imperdíveis para banho.",
      features: ["Lancha rápida", "Paradas para banho", "Vista panorâmica"],
      rating: 4.7,
      destaque: false,
      comoFunciona: "Um passeio emocionante que começa às 10h com embarque na Praia em frente ao posto Ipiranga (Perequê) ou às 10h20 no píer da Vila. Cortando as águas da costa com toda a velocidade e adrenalina, fazemos paradas de 25 minutos na Praia da Fome e 25 minutos na Praia do Saco do Eustáquio para banho nas águas cristalinas. A chegada em Castelhanos é de tirar o fôlego — tempo livre para explorar a praia, mergulhar e se encantar com a paisagem. Retorno às 15h10 com mais paradas nas praias do caminho. Embarcações vistoriadas e com todas as normas de segurança."
    },
    {
      id: 3,
    ...
    {
      id: 4,
      titulo: "Aventura 4x4 e Emocionante Experiência de Lancha",
      imagem: "/lancha e jeep.jpg",
      preco: "R$ 250/pessoa",
      duracao: "Aproximadamente 5 horas",
      pessoas: "A combinar",
      descricao: "Experiência completa e única combinando as emoções de um off-road na Mata Atlântica com a sensação de liberdade sobre o mar de Ilhabela.",
      features: ["Experiência 2 em 1", "Dia completo", "Guia especializado"],
      rating: 5.0,
      destaque: true,
      comoFunciona: "Uma experiência completa e única que combina as emoções do off-road com a sensação de liberdade sobre o mar de Ilhabela. Tudo começa aproximadamente às 10h (horários a combinar) no Perequê, em frente ao Posto Ipiranga, rumo à Praia da Fome — onde você terá entre 25 e 30 minutos para conhecer, tirar fotos e mergulhar naquelas águas incríveis. A aventura continua com parada na maravilhosa Praia do Saco do Eustáquio, mais 25 a 30 minutos para se aventurar e curtir. Depois, chegamos à paradisíaca Praia dos Castelhanos com tempo livre para banho de mar, uma caipirinha gelada, sol e muita areia. O retorno acontece após as 15h em uma única e inesquecível aventura off-road pela histórica estrada do Parque Estadual, atravessando a densa Mata Atlântica e ainda com a chance de conhecer suas encantadoras cachoeiras."
    },
    {
      id: 5,
  ...
  const toursData = [
    {
      ...
      pontos: ['Cachoeira Água Branca ou Cachoeira dos 3 Tombos (a escolher)', 'Mirante para fotos', 'Praia Grande', 'Praia do Julião'],
      preco: 'R$ 100',
    ...
    },
    {
      ...
      pontos: ['Cachoeira Água Branca ou Cachoeira dos 3 Tombos (a escolher)', 'Mirante para fotos', 'Praia do Curral'],
      preco: 'R$ 100',
      imagem: '/Tour Sul da Ilha 2.jpg'
    },
    {
      id: 'sul-aventura',
      titulo: 'Tour Sul Ilhabela Aventura',
      pontos: ['Cachoeira Água Branca ou Cachoeira dos 3 Tombos (a escolher)', 'Mirante para fotos', 'Piscina Natural', 'Praia das Conchas'],
    ...
    },
    {
      ...
      pontos: ['Mirante para fotos', 'Praia do Jabaquara — aventura offroad'],
      preco: 'R$ 110',
